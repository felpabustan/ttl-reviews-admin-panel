<template>
    ...
    <div class="flex justify-center mb-4">
        <a href="#">
            <img class="w-auto" style="height: 90px;" src="/public/TTL-logo-dark.webp" alt="">
        </a>
    </div>

    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav class="flex-1 -mx-3 space-y-3 ">
            <RouterLink to="/" class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
